...
class ViewBooking extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const RejectedBooking(title: 'View Reply'),
    );
  }
}

class RejectedBooking extends StatefulWidget {
  const RejectedBooking({super.key, required this.title});
...
class _RejectedBookingState extends State<RejectedBooking> {
  ...
  Future<void> ViewBooking() async {
    ...
    try {
      ...
      String url = '$urls/artist_view_Rejected_booking_from_user/';
