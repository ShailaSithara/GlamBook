...
class MyChatApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ChatWithUserPage(title: 'Flutter Demo Home Page'),
    );
  }
}

class ChatWithUserPage extends StatefulWidget {
  const ChatWithUserPage({super.key, required this.title});
...
class _ChatWithUserPageState extends State<ChatWithUserPage> {
  ...
  Future<void> view_message() async {
    ...
    try {
      ...
      String url = '$urls/and_artistviewchat/';
                    ...
                    FloatingActionButton(
                      onPressed: () async {
                        ...
                        try {
                          ...
                          String url = ip + "/and_artistinschat/";
