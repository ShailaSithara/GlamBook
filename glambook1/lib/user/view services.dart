...
import '../main.dart';
import 'newhome/Screens/user artist home.dart';
import 'newhome/Screens/user rental home.dart';


void main() {
  runApp(const ViewService());
}
...
class ViewService extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ViewServicePage(title: 'View Reply'),
    );
  }
}
                            ...
                            if (response.statusCode == 200) {
                              ...
                              if (status=='ok') {
                                ...
                                Navigator.push(context, MaterialPageRoute(
                                  builder: (context) => UserArtistHome(),));
                              }else {
