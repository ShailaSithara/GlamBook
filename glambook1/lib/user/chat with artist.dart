...
// import 'package:women/home2.dart';
...
class MyChatApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ChatWithArtistPage(title: 'Flutter Demo Home Page'),
    );
  }
}

class ChatWithArtistPage extends StatefulWidget {
  const ChatWithArtistPage({super.key, required this.title});
  ...
  @override
  State<ChatWithArtistPage> createState() => _ChatWithArtistPageState();
}
...
class _ChatWithArtistPageState extends State<ChatWithArtistPage> {
  int _counter = 0;
  String name = "";

  _ChatWithArtistPageState() {
  ...
  Future<void> view_message() async {
    ...
    try {
      ...
      String url = '$urls/and_userviewchat_artist/';
                    ...
                    FloatingActionButton(
                      onPressed: () async {
                        ...
                        try {
                          ...
                          String url = ip + "/and_userinschat_artist/";
