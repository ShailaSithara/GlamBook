...
//   }
//
//   Widget genderContainer(RadioListTile radioListTile,
//       RadioListTile radioListTile1) {
//     return Container(
//       margin: EdgeInsets.only(bottom: 1),
//       decoration: BoxDecoration(
//         // color: Colors.blueGrey.shade200,
...
//             image: AssetImage('assets/images/cbc.jpg'), // Replace 'assets/your_image.png' with the actual asset image path
...
//
//                       signupContainer(
//                           relationCont, 'Relation', TextInputType.name,
//                           relationError),
//
//
//                       Container(
...
//                       ),
//                       SizedBox(height: 20),
//                       Center(child: Text('Have an account ? Login'),),
//
...
//
//     String relation=relationCont.text;
//
...
//         if (status == 'ok') {
//           Fluttertoast.showToast(msg: 'Sussessfully Added');
//
