...
// import 'package:glambook/widgets/text_widget.dart';
// import 'package:curved_navigation_bar/curved_navigation_bar.dart';
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                  ...
                                  Text(user_name_, style:TextStyle(fontSize:25, color:Colors.black,
                                     fontWeight: FontWeight.bold),),
                                ],
                              )
                            ],
                  ...
                  child: AnimatedOpacity(
                    ...
                    child: CurvedNavigationBar(
                        onTap: (value) {
                          ...
                          if (value == 2) {
                            // Navigator.push(context, MaterialPageRoute(builder: (context) => User_search_staff(),));
                          }
                          if (value == 3) {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => UserChangePasswordPage(title: '',),
                                ));
                          }
                        },
                        backgroundColor: Colors.white,
          ...
          child: SizedBox(
            ...
            child: Row(
              ...
              children: [
                ...
                category1("assets/images/colortone.png", "Family", 10),
                category2("assets/images/wedding.png", "Staffs", 10),
        ...
        InkWell(
          onTap: () {
            ...
            Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => UserViewProfilePage(
                    title: '',
                  ),
                ));
          },
        ...
        InkWell(
          onTap: () {
            ...
            Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => ViewNearestShopPage(title: '',),
                ));
          },
          child: Card(
            shape:
    ...
    return Column(
      children: [
        InkWell(
          onTap: () {
            Navigator.pop(context);
            // Navigator.push(context, MaterialPageRoute(builder: (context) => Viewstaffs(title: '',),));
          },
          child: Card(
            shape:
                RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
