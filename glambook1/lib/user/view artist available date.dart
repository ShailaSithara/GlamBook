...
class ArtistViewService extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const UserViewArtistAvailabilityPage(title: 'View Reply'),
    );
  }
}

class UserViewArtistAvailabilityPage extends StatefulWidget {
  const UserViewArtistAvailabilityPage({super.key, required this.title});

  final String title;

  @override
  State<UserViewArtistAvailabilityPage> createState() => _UserViewArtistAvailabilityPageState();
}

class _UserViewArtistAvailabilityPageState extends State<UserViewArtistAvailabilityPage> {

  _UserViewArtistAvailabilityPageState(){
    ArtistViewService();
  }
  ...
  Future<void> ArtistViewService() async {
    ...
    try {
      ...
      String url = '$urls/user_view_artist_availability/';
                      ...
                      Card(
                        ...
                        Column(
                          children: [
                            ...
                            //             builder: (context) => UserViewArtistAvailabilityPage(title: "View Availability"),));
                            //         }else {
