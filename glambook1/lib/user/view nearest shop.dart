...
import 'package:glambook/user/send%20rating%20&%20review%20about%20shop.dart';
...
import 'package:glambook/user/view%20shop%20products.dart';
...
void main() {
  runApp(const ViewNearestShop());
}

class ViewNearestShop extends StatelessWidget {
  const ViewNearestShop({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ViewNearestShopPage(title: 'View Reply'),
    );
  }
}

class ViewNearestShopPage extends StatefulWidget {
  const ViewNearestShopPage({super.key, required this.title});

  final String title;

  @override
  State<ViewNearestShopPage> createState() => _ViewNearestShopPageState();
}

class _ViewNearestShopPageState extends State<ViewNearestShopPage> {

  _ViewNearestShopPageState(){
    ViewNearestShop();
  }
  ...
  Future<void> ViewNearestShop() async {
    ...
    try {
      ...
      String url = '$urls/user_view_nearestshop/';
                            ...
                            children: [
                              Column(
                                children: [
                                  ...
                                  ElevatedButton(
                                    onPressed: () async {
                                      ...
                                      Navigator.push(context, MaterialPageRoute(
                                        ...
                                        builder: (context) => ViewShopProductPage(title: ""),));
                                    },
                                    child: Text("Product"),
                                  ),
                                  ElevatedButton(
                                  ...
                                  //     Navigator.push(
                                  //       context,
                                  //       MaterialPageRoute(builder: (context) => ReviewShop(title: ""),),
                                  //     );
                                  //   },
                                  //   child: Text("Rating"),
                                  // ),
