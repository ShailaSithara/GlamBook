...
void main() {
  runApp(const ViewRentalPayment());
}

class ViewRentalPayment extends StatelessWidget {
  const ViewRentalPayment({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ViewRentalPaymentPage(title: 'View Reply'),
    );
  }
}

class ViewRentalPaymentPage extends StatefulWidget {
  const ViewRentalPaymentPage({super.key, required this.title});

  final String title;

  @override
  State<ViewRentalPaymentPage> createState() => _ViewRentalPaymentPageState();
}

class _ViewRentalPaymentPageState extends State<ViewRentalPaymentPage> {

  _ViewRentalPaymentPageState(){
    ViewRentalPayment();
  }
  ...
  Future<void> ViewRentalPayment() async {
    ...
    try {
      ...
      String url = '$urls/user_rental_view_payment/';
