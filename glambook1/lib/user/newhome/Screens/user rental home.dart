...
class UserRentalHome extends StatefulWidget {
  const UserRentalHome({super.key});

  @override
  State<UserRentalHome> createState() => _UserRentalHomeState();
}

class _UserRentalHomeState extends State<UserRentalHome> {
  _UserRentalHomeState(){
    ViewProduct("");
  }
  @override
                  ...
                  ListView(
                    ...
                    children: [
                      Padding(
                        ...
                        child: InkWell(
                          onTap: (() {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => ViewNearestShopPage(title: '',),));
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          onTap: (() {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => ViewCartPage(title: '',),));
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          onTap: (() {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => ProductBookingPage(title: '',),));
                        ...
                        child: InkWell(
                          onTap: (() {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => ViewRentalPaymentPage(title: '',),));
  ...
  Future<void> ViewProduct(value) async {
    ...
    try {
      ...
      String url = '$urls/user_viewproduct_home/';
